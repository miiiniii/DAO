...
public class ListenerConfiguration {
    ...
    @Bean
    ConcurrentKafkaListenerContainerFactory<String, KafkaMSG> kafkaListenerContainerFactory() {
    ...
    public ConsumerFactory<String, KafkaMSG> consumerFactory() {
        return new DefaultKafkaConsumerFactory<>(consumerConfigurations(), new StringDeserializer(), new JsonDeserializer<>(KafkaMSG.class));
    }
