...
export default function ContractForm(props){
	...
	if (props.type === 'art' && props.viewContract === false){
    	...
    	else if (props.type === 'art' && props.viewContract=== true){
    		return(
    			<div className='contractList'>
    				<h1>계약서 작성</h1>
    				<div className='contractContainer'>
    					...
    					<div className='sendBtnContainer'>
    						<button className='sendBtn' onClick={openModModal}>수정</button>
    						<ModifyModal showModModal={showModModal} closeModModal={closeModModal} type = {props.type} contractDate={contractDate} setSign={props.setSign} sign={props.sign}></ModifyModal>
    					</div>
    				</div>
    			</div>
    		)
    	}
    	else if (props.type === 'rEstate' && props.viewContract=== true){
    		return(
    			<div className='contractList'>
    				<h1>계약서 작성</h1>
    				<div className='contractContainer'>
